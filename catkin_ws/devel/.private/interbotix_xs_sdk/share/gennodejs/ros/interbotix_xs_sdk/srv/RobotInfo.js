...
// (in-package interbotix_xs_sdk.srv)
...
class RobotInfoRequest {
  ...
  static datatype() {
    ...
    return 'interbotix_xs_sdk/RobotInfoRequest';
  }
...
class RobotInfoResponse {
  ...
  static getMessageSize(object) {
    ...
    length += object.profile_type.length;
  ...
  static datatype() {
    // Returns string type for a service object
    return 'interbotix_xs_sdk/RobotInfoResponse';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'aab05469cfeca32ce718e0ba473d9ba5';
  }
...
module.exports = {
  ...
  md5sum() { return '7a389566d99903aa71839d0052c9a055'; },
  datatype() { return 'interbotix_xs_sdk/RobotInfo'; }
};
